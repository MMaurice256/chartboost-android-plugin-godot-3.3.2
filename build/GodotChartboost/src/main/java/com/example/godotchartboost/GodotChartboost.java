...
public class GodotChartboost extends GodotPlugin {
    ...
    public GodotChartboost(Godot godot) {           //  Constructor
        super(godot);
        activity=godot.getActivity();               // This line will only work if build.gradle synced with dependency    compileOnly project(":GODOT-LIBRARY-AAR")
    ...
    @Override
    public List<String> getPluginMethods() {    // Method is DEPRECATED but I included it for consistency with other Version 3's of Godot. Also because it may be used by the Godot class written in gdscript
